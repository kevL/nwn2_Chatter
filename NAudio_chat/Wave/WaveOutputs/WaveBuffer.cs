...
namespace NAudio.Wave
{
	...
	/// (<see cref="ByteBuffer"/>, <see cref="FloatBuffer"/>, <see cref="ShortBuffer"/>, <see cref="IntBuffer"/>)
	/// that are pointing to the same memory buffer. Use the associated Count property
	/// based on the type of buffer to get the number of data in the buffer.
	/// <br/><br/>
...
/*			if (bufferToBoundTo.Length % 4 != 0)
		...
		/// <summary>
		/// Performs an implicit conversion from <see cref="NAudio.Wave.WaveBuffer"/>
		/// to <see cref="System.Byte"/>.
		/// </summary>
